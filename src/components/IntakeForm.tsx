...
const TEXT_MUTED = '#6B4A20';
const LABEL_C = '#3D1500';
const BG_WHITE = '#FFFFFF';
const BORDER = '#DDD8F5';
const TEAL_BG = 'rgba(184,134,11,0.07)';
const TEAL_BR = 'rgba(184,134,11,0.22)';
const AMBER_BG = 'rgba(139,26,26,0.08)';
...
const focusSt = { borderColor: TEAL, boxShadow: '0 0 0 3px rgba(184,134,11,0.12)' } as React.CSSProperties;
    ...
    <motion.form onSubmit={handleSubmit}
      ...
      <div className="p-5 sm:p-7 space-y-6">
        ...
        <button type="submit" disabled={!form.consent || loading}
          ...
          style={{ background: `linear-gradient(135deg, ${TEAL} 0%, #7C3AED 40%, ${AMBER} 100%)`, color: '#FFFFFF', letterSpacing: '0.03em', boxShadow: '0 4px 20px rgba(184,134,11,0.30)' }}>
          {loading
