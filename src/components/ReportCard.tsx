  ...
  async function sendWeeklyFollowUp(msg: string) {
    ...
    try {
      ...
      const weeklyCtx = [
        ...
        `⚠️ CURRENT AGE: ${ctx.currentAge} | Year: ${new Date().getFullYear()} — timing predictions must be realistic for this age.`,
  ...
  async function sendFollowUp(msg: string) {
    ...
    try {
      ...
      const chartSummary = [
        ...
        `⚠️ CURRENT AGE: ${ctx.currentAge} | Current year: ${new Date().getFullYear()} — ALL timing predictions must be realistic for this age. Marriage prediction must NOT go beyond age 50. Always find at least one favorable window within the next 3-5 years using antardasha sub-periods.`,
